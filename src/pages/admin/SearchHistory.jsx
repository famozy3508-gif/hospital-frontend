      ...
      {editingAllergy ? (
        <div className="info-box">
          ...
          <form onSubmit={handleAllergySubmit} style={{ marginTop: 10 }}>
            ...
            <input value={allergyForm.allergy_name} onChange={(e) => setAllergyForm({ ...allergyForm, allergy_name: e.target.value })} maxLength={255} required />
            <p style={{ fontSize: 12, color: '#888', margin: '2px 0 8px' }}>{allergyForm.allergy_name.length}/255 ตัวอักษร</p>
        ...
        <div className="info-box">
          ...
          <form onSubmit={handleAllergySubmit} style={{ marginTop: 10 }}>
            <label>ชื่อยา/สารที่แพ้</label>
            <input value={allergyForm.allergy_name} onChange={(e) => setAllergyForm({ ...allergyForm, allergy_name: e.target.value })} placeholder="เช่น เพนิซิลลิน" maxLength={255} required />
            <p style={{ fontSize: 12, color: '#888', margin: '2px 0 8px' }}>{allergyForm.allergy_name.length}/255 ตัวอักษร</p>
            <label>อาการที่เกิดขึ้น</label>
